...
const createGrpcClient = (protoPath, packageName, serviceName, address) => {
    const packageDefinition = protoLoader.loadSync(protoPath, grpc_options_1.grpcLoaderOptions);
    const grpcPackage = grpc.loadPackageDefinition(packageDefinition);
    const Service = grpcPackage[packageName][serviceName];
